...
<p> ![Order Details Contains Products](Images/Order_Detail_Contains_Products.png "Figure 2 - OrderDetails Contains Products") </p>
...
<p> ![Customer Has Order Details](Images/Cust_Has_OrderDetails.png "Figure 3 - Customer Has Order Details") </p>
...
<p> ![Product Belong to Category](Images/Product_BelongTo_Cat.png "Figure 4 - Product Belong to Category") </p>
...
<p> ![Category Has Sub-Categories](Images/Cat_Has_SubCat.png "Figure 5 - Category Has Sub-Category") </p>
...
<p> ![Product Qualifies For Discount](Images/Product_Qualify_Discount.png "Figure 7 - Product Qualifies For Discount") </p> 
...
<p> ![Product Has Reviews](Images/Product_Has_Reviews.png "Figure 8 - Product Has Reviews") </p> 
...
**Missed FKs** Please consider them
...
<p>Second phase was the automation process utilising workflow that trigger on specific events like push request to perform data updates, validation, and analysis. This will pick up any new data added to the data base and subsequently perform the required validation and analysis as illustrated in **Figures 9, 10 , and 11** In **Figure 12** the snippet is Timestamps that showed as an evidence of a working workflow </p>

<p> ![The histogram of customers data for 50 records](Images/Workflow1.png "Figure 9 - The histogram of customers data for 50 records") </p>

<p> ![The histogram after workflow run and inserted additional 100 records](Images/Workflow2.png "Figure 10 -The histogram after workflow run and inserted additional 100 records")</P>

<p> The below figure shows the record count after 1st run of workflow (49) and then after second run of workflow (150).</p>

<p> ![Record count after data update using workflow](Images/Console_Workflow.png "Figure 11 - Console Output") </p>


<p> ![Workflow Timestamps](Images/WorkflowTimestamps.png "Figure 12 - Workflow Timestamps")</p>
...
The graph in **Figure 13** shows the distribution of product ratings from 0 to 5 coloured by category name. Followed by **Figure 14** reflecting Top 5 Products Sorted by total Revenue. [How Revenue is calculated by using join statement]

<p> ![Distribution of Product Ratings by Category](Images/Product_Rating_By_Category.jpeg "Figure 13 - Distribution of Product Ratings by Category")</p>


<p> ![Top 5 Products by Revenue](Images/Top_5_Products_Revenue.png "Figure 14 - Top 5 Products by Revenue") </p>


The graph in **Figure 15**  shows the distribution of customers by phone country codes.
 

<p> ![Distribution of Customers by Phone Country Code](Images/Cust_Phone_Country_Code_Distribution.png "Figure 15- Distribution of Customers by Phone Country Code")</p>

**Figure 16** displays the order status count of shipped, processing, delivered and cancelled orders. 

<p> ![Order Status Count](Images/Order_Status_Distribution.png "Figure 16- Order Status Count") </p>
...
<p> ![ChatGPT_1](Images/ChatGPT-GenerateDataPrompt1.png "A.1 - ChatGPT_1") </p>

## Appendix 2

# <p> ![ChatGPT_2](Images/ChatGPT-GenerateDataPrompt2.png "A.2 - ChatGPT_2") </p>
