...
Products <- Products %>%
  mutate(Category_ID = sample(Product_Category$Category_ID, nrow(Products), replace = TRUE))

Products <- Products %>%
  mutate(Supplier_ID = sample(Suppliers$Supplier_ID, nrow(Products), replace = TRUE))
