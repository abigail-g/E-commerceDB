...
![](Images/product_rating_by_category.jpeg "Distribution of Product Ratings by Category")

The graph above shows the distribution of product ratings from 0 to 5 coloured by category name.


![](Images/top_5_products_revenue.png "Top 5 Products by Revenue")

The graph above shows the top 5 products in terms of revenue.


![](Images/Cust_Country_Code_Distribution.png "Distribution of Customers by Country Code")

The graph above shows the distribution of customers by country code.

![](Images/order_status_distribution.png "Order Status Count")
