...
####   1.1.2.5  Category and Sub-Category
...
# 1.1.3. Relationship and Cardinalities 
...
4. Category Self-Reference Relation 
...
5. Product Supplied_By Supplier
...
6. Product Qualifies_For Discount
...
<!-- Customers ($\underline{Customer}$_id, Customer_Email, Cust_F_Name, Cust_L_Name, Phone_Country_Code, Phone_Num, Cust_Street_Name, Cust_Building_Name, Cust_Zip_Code) -->
...
<!-- Many to Many relation of Supplier and Product  -->
<!-- SupplierProduct ($\underline{Supplier_id,Product_id}$) -->

<!-- Many to Many relation of Order_details and Product  -->
