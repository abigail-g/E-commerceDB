...
Products ($\underline{Product_id}$, ${\textit{Discount_id}}$, ${\textit{Category_id}}$, Product_Name, Product_Price, Product_Availability)

Suppliers ($\underline{Supplier_id}$, Supplier_Email, Supplier_Name, Supplier_Status, Sup_Building_Name, Sup_Street_Name, Sup\_ Zip_Code)
