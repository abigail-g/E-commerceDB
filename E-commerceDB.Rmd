...
Products ($\underline{\text{Product\_id}}$, *Discount_Code*, *Category_id*, Product_Name, Product_Price, Product_Availability)
...
Cust_Building_Number, Cust_Building_Name, Cust_Street_Name, Cust_Zip_Code, Cust_Country_Code seem to depend on Cust_ID.

Cust_First_Name, Cust_Last_Name, Cust_Email, Cust_Phone_Number also seem to depend only on Cust_ID.

There doesn't appear to be any transitive dependencies based on the given attributes.
...
The process was done manually to the very few cells that still don’t make any sense related to e-commerce context or were left blank and AI tools missed to produce. 
...
![Distribution of Product Ratings by Category](Images/Product_Rating_By_Category.jpeg "Distribution of Product Ratings by Category")

The graph above shows the distribution of product ratings from 0 to 5 coloured by category name.
...
![Distribution of Customers by Country Code](Images/Cust_Country_Code_Distribution.png "Distribution of Customers by Country Code")

The graph above shows the distribution of customers by country code.

![Order Status Count](Images/Order_Status_Distribution.png "Order Status Count")
...
![ChatGPT](Images/ChatGPT-GenerateDataPrompt1.png "ChatGPT")
## Appendix 2

![ChatGPT](Images/ChatGPT-GenerateDataPrompt2.png "ChatGPT")
