...
![RMS](Cust_Order_Products.png "Relationship Set")
...
![RMS](Cust_Orders_OrderDetails.png "Relationship Set")
...
![RMS](Product_BelongTo_Cat.png "Relationship Set")
...
![RMS](Cat_Has_SubCat.png "Relationship Set")
...
![RMS](Product_SuppliedBy_Supplier.png "Relationship Set")
...
![RMS](Product_Qualify_Discount.png "Relationship Set")
...
![RMS](Product_Has_Reviews.png "Relationship Set")
...
![](product_rating_by_category.jpeg "Distribution of Product Ratings by Category")

The graph above shows the distribution of product ratings from 0 to 5 coloured by category name. The number of reviews for each category is quite balanced, with rating level of 5 having the most reviews. 


![](top_5_products_revenue.png "Top 5 Products by Revenue")

![](Cust_Country_Code_Distribution.png "Distribution of Customers by Country Code")


![](order_status_distribution.png "Order Status Count")
...
![ChatGPT](ChatGPT-GenerateDataPrompt1.png "ChatGPT")
## Appendix 2

![ChatGPT](ChatGPT-GenerateDataPrompt2.png "ChatGPT")
